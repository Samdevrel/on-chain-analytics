      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Advanced on-chain analysis tools for Bitcoin - whale tracking, transaction clustering, and market intelligence.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Track large Bitcoin transactions and wallets</li>
            <li>Cluster addresses by ownership patterns</li>
            <li>Analyze whale movements</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            ...
            <li>✓ Network heatmap visualization</li>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Set up custom analytics filters</li>
            <li>Monitor whale transactions</li>
            <li>Analyze address clusters</li>
          </ol>
        </section>
